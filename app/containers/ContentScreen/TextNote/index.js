...
export class TextNote extends React.Component {
  ...
  onFromSend(){
    ...
    description: 'Text submission module is under construction, be patience please. :)',
  });
  }
  render() {
    return (
         ...
         <TextNoteStyle>
          <Row type="flex" justify="center" align="middle" style={{ height: "100%" }} >
              <Col xs={{ span: 24 }} sm={{ span: 18 }} md={{ span: 14 }} lg={{ span: 8 }} xl = {{span: 9}} xxl={{span:7}}>
                <Input value={this.state.inputValue1} placeholder="Source link" className="animated zoomIn slow-2s delay-0s"/>
                <Input.TextArea value={this.state.inputValue2} autosize={{ minRows: 6, maxRows: 6 }} style={{resize: "none"}} placeholder="Add some text and tags … " className="animated zoomIn slow-2s delay-0s"/>
