...
export class TextNote extends React.Component {
         constructor(props) {
           super(props);
           this.state = { getSelection: "",listItems: ["Racing car sprays burning fuel into crowd.", "Japanese princess to wed commoner.", "Australian walks 100km after outback crash.", "Man charged over missing wedding girl.", "Los Angeles battles huge wildfires."], text: "", menu: <Menu>
                 <Menu.Item>
                 ...
                 <Menu.Item>
                   <NavLink to="/login" className="navigation-item" activeClassName="navigation-item--active">
                     <span>Logout</span>
                   </NavLink>
                 </Menu.Item>
               </Menu>, suggestions: [], visible: false, selectedText: [], inputValue1: "", inputValue2: toContentState(""), randomText: { title: "https://www.opentable.com/r/sushi-ginza-onodera-new-york? …", para: "Anastasia is a great vegan cafe to meet friends. They have a delicious and nutritious breakfast with loads of tasty dips, good salads, and incredible cakes. They treat every dish like it is a multi-layered experience, they take all the senses into account." } };
         ...
         handleChange = editorState => {
           this.setState({ inputValue2: editorState });
         };
         getSelectedText = e => {
           alert(1);
                ...
                /> */}
                     ...
                     <Col>
                       <Row className="animated zoomIn slow-2s delay-0s" type="flex" justify="start" align="top">
                         <Col>
                           <IconButton icon="tag" onClick={() => this.dropTags} style={{ marginLeft: "20px", marginTop: "20px" }} />
                         </Col>
                       </Row>
                     </Col>
                   </Row>
