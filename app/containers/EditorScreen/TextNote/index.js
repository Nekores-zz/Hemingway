              ...
              <Col className="animated zoomIn slow-2s delay-0s" xs={{ span: 24 }} sm={{ span: 9 }} md={{ span: 10 }} lg={{ span: 8 }} xl={{ span: 9 }} xxl={{ span: 7 }}>
                <div>
                  <p className="_textnote">
                    Anastasia is a great vegan cafe to meet friends. They have a delicious and nutritious <a href="#">
                      {" "}
                      breakfast{" "}
                    </a> with loads of tasty dips, good salads, and incredible cakes. They treat every dish like it is a multi-layered experience, they take all the senses into account.
                  </p>
                </div>
              </Col>
              <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 10 }} xl={{ span: 11 }} xxl={{ span: 9 }}>
                <Row>
                  ...
                  <Col xs={{ span: 24 }} sm={{ span: 4 }} md={{ span: 4 }} lg={{ span: 4 }} xl={{ span: 4 }} xxl={{ span: 4 }}>
                    <Button type="primary" className="animated zoomIn slow-2s delay-0s" onClick={this.onFromSend} style={{ marginLeft: "20px" }}>
                      Submit
                    </Button>
                    <IconButton icon="tag" className="animated zoomIn slow-2s delay-0s" onClick={() => alert("no tags found!")} style={{ marginLeft: "20px", marginTop: "20px" }} />
                  </Col>
                </Row>
              </Col>
            </Row>
